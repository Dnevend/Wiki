...
&emsp;&emsp;因为这样的出发点，顺手也想尝试下浏览器插件的开发，便产生了 [X-Comfort-Browser](https://x-comfort-browser.dnevend.site/) 这个小工具。
...
只因为是先接触到了 WXT，所以该插件就基于 WXT 来进行了开发。
...
- [官网 - X-Comfort-Browser](https://x-comfort-browser.dnevend.site/)
...
- [Github - 开源项目](https://github.com/dnevend/x-comfort-browse/)
